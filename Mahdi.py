...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/MAHDI-Shuvo/lol/main/ments.txt').text
    if to in r:
        notice()
    else:
        os.system('clear')
        ...
        os.system('xdg-open hhttps://wa.me/0188748882')
        reg()
...
def reg2():
    ...
    raw_input('\t\x1b[1;97m  And Press \x1b[1;91menter \x1b[1;97mto Input Api')
    print ''
    os.system('xdg-open https://wa.me/0188748882')
    time.sleep(5)
